...
export default function HowToApply({ steps, destinationName }: { steps: Step[]; destinationName: string }) {
  if (!steps.length) return null;
  return (
    <section className="mt-10" aria-label="How to apply">
      <h2 className="text-xl font-semibold text-slate-800">How to apply for a {destinationName} student visa, step by step</h2>
